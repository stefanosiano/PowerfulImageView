 ...
 * if the drawable is a [ColorDrawable] the bitmap created will be 1x1 size, otherwise [w]x[h]]
 */
@Throws(IllegalArgumentException::class)
internal fun Drawable.createBitmap(w: Int, h: Int): Bitmap {

    val bitmap = if (hasNoIntrinsicSize()) Bitmap.createBitmap(1, 1, Bitmap.Config.ARGB_8888)
