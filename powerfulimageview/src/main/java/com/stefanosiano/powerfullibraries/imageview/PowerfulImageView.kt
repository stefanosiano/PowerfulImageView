...
open class PowerfulImageView : ImageViewWrapper {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int): super(context, attrs, defStyleAttr) {
        ...
        val a = context.theme.obtainStyledAttributes(attrs, com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView, defStyleAttr, 0)
        ...
        a.getValue(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_size, tvSize)
        a.getValue(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_border_width, tvBorderWidth)
        a.getValue(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_shadow_padding, tvShadowPadding)
        ...
        val progressOptions = ProgressOptions(
                ...
                a.getDimensionPixelSize(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_padding, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_PROGRESS_PADDING.toFloat(), resources.displayMetrics).toInt()),
                a.getFloat(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_value, DEFAULT_PROGRESS_VALUE.toFloat()),
                getColor(a, com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_front_color, com.stefanosiano.powerfullibraries.imageview.R.color.piv_default_progress_front_color),
                getColor(a, com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_back_color, com.stefanosiano.powerfullibraries.imageview.R.color.piv_default_progress_back_color),
                getColor(a, com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_indeterminate_color, com.stefanosiano.powerfullibraries.imageview.R.color.piv_default_progress_indeterminate_color),
                a.getInteger(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_gravity, DEFAULT_PROGRESS_GRAVITY),
                Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1 && layoutDirection == View.LAYOUT_DIRECTION_RTL,
                a.getBoolean(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_rtl_disabled, DEFAULT_PROGRESS_DISABLE_RTL_SUPPORT),
                a.getBoolean(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_indeterminate, DEFAULT_PROGRESS_INDETERMINATE),
                a.getBoolean(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_draw_wedge, DEFAULT_PROGRESS_DETERMINATE_DRAW_WEDGE),
                a.getBoolean(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_shadow_enabled, DEFAULT_PROGRESS_SHADOW_ENABLED),
                getColor(a, com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_shadow_color, com.stefanosiano.powerfullibraries.imageview.R.color.piv_default_progress_shadow_color),
                ...
                a.getDimensionPixelSize(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_shadow_border_width, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_PROGRESS_SHADOW_BORDER_WIDTH.toFloat(), resources.displayMetrics).toInt()).toFloat(),
                getColor(a, com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_shadow_border_color, com.stefanosiano.powerfullibraries.imageview.R.color.piv_default_progress_shadow_border_color),
                a.getBoolean(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_reversed, DEFAULT_PROGRESS_REVERSED),
                a.getBoolean(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_progress_removed_on_change, DEFAULT_PROGRESS_REMOVED_ON_CHANGE)
        )


        val tvShapeInnerPadding = TypedValue()
        a.getValue(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_shape_inner_padding, tvShapeInnerPadding)

        val shapeOptions = ShapeOptions(
                getColor(a, com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_shape_background_color, android.R.color.transparent),
                getColor(a, com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_shape_foreground_color, android.R.color.transparent),
                ...
                a.getBoolean(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_shape_border_overlay, DEFAULT_SHAPE_BORDER_OVERLAY),
                getColor(a, com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_shape_border_color, android.R.color.transparent),
                a.getDimensionPixelSize(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_shape_border_width, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_SHAPE_BORDER_WIDTH.toFloat(), resources.displayMetrics).toInt()),
                a.getFloat(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_shape_ratio, DEFAULT_SHAPE_RATIO),
                a.getFloat(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_shape_radius_x, DEFAULT_SHAPE_RADIUS_X),
                a.getFloat(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_shape_radius_y, DEFAULT_SHAPE_RADIUS_Y),
                getColor(a, com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_shape_solid_color, com.stefanosiano.powerfullibraries.imageview.R.color.piv_default_shape_solid_color),
                a.getDrawable(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_shape_background),
                a.getDrawable(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_shape_foreground)
        )


        val shapeMode = PivShapeMode.fromValue(a.getInteger(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_shape_mode, DEFAULT_SHAPE_MODE))
        //I use the android scale type used as default. If a PivShapeScaleType type is passed, it overrides Android scaleType
        val scaleType = PivShapeScaleType.fromValue(a.getInteger(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_shape_scaleType, PivShapeScaleType.getFromScaleType(scaleType).value))


        val blurOptions = BlurOptions(
                a.getFloat(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_blur_down_sampling_rate, DEFAULT_BLUR_DOWNSAMPLING_RATE),
                a.getBoolean(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_blur_static, DEFAULT_BLUR_STATIC),
                a.getBoolean(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_blur_use_rs_fallback, DEFAULT_BLUR_USE_RENDERSCRIPT_FALLBACK),
                a.getInteger(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_blur_num_threads, DEFAULT_BLUR_NUM_THREADS)
        )

        val blurRadius = a.getInteger(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_blur_radius, DEFAULT_BLUR_RADIUS)
        val blurModeValue = a.getInteger(com.stefanosiano.powerfullibraries.imageview.R.styleable.PowerfulImageView_piv_blur_mode, DEFAULT_BLUR_MODE)
