...
class CircularProgressDrawer : ProgressDrawer {
    ...
    init {
        ...
        mProgressAnimator.duration = if (mProgressAnimationDuration < 0) com.stefanosiano.powerfulimageview.progress.drawers.DEFAULT_ANIMATION_DURATION else mProgressAnimationDuration
