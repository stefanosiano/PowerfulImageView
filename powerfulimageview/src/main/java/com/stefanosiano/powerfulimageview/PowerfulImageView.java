 ...
 */
public class PowerfulImageView extends AppCompatImageView {
    ...
    public PowerfulImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ProgressOptions progressOptions = new ProgressOptions(
                ...
                a.getColor(R.styleable.PowerfulImageView_piv_progress_shadow_color, ContextCompat.getColor(context, R.color.piv_default_progress_shadow_color)),
