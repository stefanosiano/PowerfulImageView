 ...
 */(view: View, shapeOptions: ShapeOptions) : ShapeOptions.ShapeOptionsListener {
    ...
    private var mMeasuredWidth: Float = 0.toFloat()

    /** Measured height, based on mode  */
    private var mMeasuredHeight: Float = 0.toFloat()


    //Drawers
    private var mCircleShapeDrawer: CircleShapeDrawer? = null
    private var mNormalShapeDrawer: NormalShapeDrawer? = null
    private var mOvalShapeDrawer: OvalShapeDrawer? = null
    private var mSolidCircleShapeDrawer: SolidCircleShapeDrawer? = null
    private var mRoundedRectangleShapeDrawer: RoundedRectangleShapeDrawer? = null
    private var mSolidOvalShapeDrawer: SolidOvalShapeDrawer? = null
    private var mSolidRoundedRectangleShapeDrawer: SolidRoundedRectangleShapeDrawer? = null
    ...
    fun changeDrawable(drawable: Drawable?) {
        ...
        if (mShapeDrawer?.requireBitmap() == true) {
    ...
    private fun updateDrawers(shapeMode: PivShapeMode?) {
        ...
        mShapeDrawer = when (shapeMode ?: PivShapeMode.NORMAL) {
            PivShapeMode.CIRCLE -> { mCircleShapeDrawer = mCircleShapeDrawer ?: CircleShapeDrawer(getBitmapFromDrawable(mDrawable, mDrawable)); mCircleShapeDrawer }
            PivShapeMode.SQUARE -> { mNormalShapeDrawer = mNormalShapeDrawer ?: NormalShapeDrawer(mDrawable); mNormalShapeDrawer }
            PivShapeMode.RECTANGLE -> { mNormalShapeDrawer = mNormalShapeDrawer ?: NormalShapeDrawer(mDrawable); mNormalShapeDrawer }
            PivShapeMode.OVAL -> { mOvalShapeDrawer = mOvalShapeDrawer ?: OvalShapeDrawer(getBitmapFromDrawable(mDrawable, mDrawable)); mOvalShapeDrawer }
            PivShapeMode.ROUNDED_RECTANGLE -> { mRoundedRectangleShapeDrawer = mRoundedRectangleShapeDrawer ?: RoundedRectangleShapeDrawer(getBitmapFromDrawable(mDrawable, mDrawable)); mRoundedRectangleShapeDrawer }
            PivShapeMode.SOLID_CIRCLE -> { mSolidCircleShapeDrawer = mSolidCircleShapeDrawer ?: SolidCircleShapeDrawer(mDrawable); mSolidCircleShapeDrawer }
            PivShapeMode.SOLID_OVAL -> { mSolidOvalShapeDrawer = mSolidOvalShapeDrawer ?: SolidOvalShapeDrawer(mDrawable); mSolidOvalShapeDrawer }
            PivShapeMode.SOLID_ROUNDED_RECTANGLE -> { mSolidRoundedRectangleShapeDrawer = mSolidRoundedRectangleShapeDrawer ?: SolidRoundedRectangleShapeDrawer(mDrawable); mSolidRoundedRectangleShapeDrawer }
            PivShapeMode.NORMAL -> { mNormalShapeDrawer = mNormalShapeDrawer ?: NormalShapeDrawer(mDrawable); mNormalShapeDrawer }
            else -> { mNormalShapeDrawer = mNormalShapeDrawer ?: NormalShapeDrawer(mDrawable); mNormalShapeDrawer }
        }
    }
