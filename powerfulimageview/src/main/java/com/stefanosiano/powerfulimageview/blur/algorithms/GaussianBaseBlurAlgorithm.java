...
/**
 * Base class that performs the gaussian blur. Should be overridden to provide the coefficients to use.
 * Changing radius will repeat the process radius times.
 */

abstract class GaussianBaseBlurAlgorithm implements BlurAlgorithm {
